...
const AddPackages = () => {
    ...
    const handleImageUpload = async () => {
        ...
        for (const file of imageFiles) {
            ...
            data.append('upload_preset', 'unitaxtour1100'); // Replace with your upload preset
            data.append('cloud_name', 'dk95heui2'); // Replace with your Cloudinary cloud name

            try {
                const res = await axios.post(
                    `https://api.cloudinary.com/v1_1/dk95heui2/image/upload`, // Replace with your cloud_name
                    data
                );
    ...
    const handleSubmit = async (e) => {
            ...
            .then(response => {
                ...
                if (response.data.insertedId) {
                    Swal.fire({
                      ...
                      // 🔁 Reset all form data after successful submit
                setFormData({
                    packageTitle: '',
                    price: '',
                    currency: 'USD',
        ...
        console.log('Tour Package Data:', formData);
    };
